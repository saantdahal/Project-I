...
<body>
    <div class="flex-container">
        <div class="flex-item">
            ...
            <h1 id="customer">
                Welcome,
                <?php echo $row0["first_name"] ?>&nbsp
                <?php echo $row0["last_name"] ?>&nbsp!
            ...
            <p id="customer">
                ...
                &#9656 Balance (NRP):
                <?php echo number_format($row1["balance"]); ?>/-

                <br>&#9656 You have
                <?php echo $row2["COUNT(*)"]; ?> beneficiaries.

                <br>&#9656 Your last transaction (
                <?php echo $type; ?>) of&nbspRs.&nbsp
                <?php
                echo number_format($transaction); ?>
                <br>
                on
                <?php echo $sanitized_time; ?>, was: "
