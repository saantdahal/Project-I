...
<body>
    <form class="add_customer_form" action="customer_profile_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div class=container>
                <label>First Name : <label id="info_label">
                        <?php echo $fname ?>
                    </label></label>
            </div>

            <div class=container>
                <label>Last Name : <label id="info_label">
                        <?php echo $lname ?>
                    </label></label>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <label>Balance (NRP) : <label id="info_label">
        ...
        <div class="flex-container">
            <div class=container>
                <label>Date of Birth : <label id="info_label">
                        <?php echo $dob ?>
                    </label></label>
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <label>citizenship No : <label id="info_label">
            ...
            <div class=container>
                <label>Bank Branch :
                    <label id="info_label">
                        ...
                        if ($branch == "Kathmandu") {
                            echo "Kathmandu";
                        } elseif ($branch == "Bhaktpur") {
                            echo "Bhaktpur";
                        } elseif ($branch == "Lalitpur") {
                            echo "Lalitpur";
                        } elseif ($branch == "Dhading") {
                            echo "Dhading";
                        } elseif ($branch == "Head Office") {
                            echo "Head Office";
                        }
                        ?>
                    </label>
