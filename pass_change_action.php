...
<body>
    <div class="flex-container">
        <div class="flex-item">
            ...
            if ($err_no == 0) { ?>
                <p id="info">
                    <?php echo $info_string . " successfully changed !\n";
                    ?>
                </p>
            <?php } ?>
            ...
            if ($err_no == 1) { ?>
                <p id="info">
                    <?php echo "Old " . $info_string . " is incorrect !\n";
                    ?>
                </p>
            <?php } ?>
            ...
            if ($err_no == 2) { ?>
                <p id="info">
                    <?php echo $info_string . "s do not match !\n";
                    ?>
                </p>
            <?php } ?>
            ...
            if ($err_no == 3) { ?>
                <p id="info">
                    <?php echo "Old & new " . $info_string . "s are same !\n";
                    ?>
                </p>
            <?php } ?>
        </div>
