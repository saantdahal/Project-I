    ...
    <form class="add_customer_form" action="edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <label>Balance (NRS) : <label id="info_label">
        ...
        <div class="flex-container">
            <div class=container>
                ...
                <input name="citizenship" size="25" type="text" value="<?php echo $citizenship ?>" required />
            </div>
        </div>
        ...
        <div class="flex-container">
            ...
            <div class=container>
                ...
                <select name="branch">
                    <option value="Kathmandu" <?php if ($branch == 'Kathmandu') { ?> selected="selected" <?php } ?>>
                        Kathmmandu</option>

                    <option value="Bhaktpur" <?php if ($branch == 'Bhaktpur') { ?> selected="selected" <?php } ?>>
                        Bhaktpur</option>

                    <option value="Lalitpur" <?php if ($branch == 'Lalitpur') { ?> selected="selected" <?php } ?>>
                        Lalitpur</option>

                    <option value="Dhading" <?php if ($branch == 'Dhading') { ?> selected="selected" <?php } ?>>
                        Dhading</option>

                    <option value="Head office" <?php if ($branch == 'Head Office') { ?> selected="selected" <?php } ?>>Head Office
                    </option>
                </select>
